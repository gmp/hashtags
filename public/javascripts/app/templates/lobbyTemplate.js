ht.Templates.LobbyTemplate = _.template(''+
  '<div class="row lobby-header">'+
    ...
    '<div class="small-2 columns">'+
      '<button data-modal-id="new-game-modal" id="new-game-button" class="small button newGame">+</button><br>'+
    '</div>'+
  '</div>'+
  '<% if (games.length === 0 && invites.length === 0 && pendingGames.length === 0) { %>'+
    '<div class="row noGames">'+
      '<div class="small-10 small-centered columns">'+
        '<p>You have no games!<br><br>Click here <br><button data-modal-id="new-game-modal" id="new-game-button" class="small button newGame">+</button><br>to get started</p>'+
      '</div>'+
    '</div>'+
  '<% } %>'+
